...
PWM_In_POS PWM_POS_Judge(u16 AUXN)
{
	...
	else if(AUXN < PWM_RC_MID + 50 && AUXN > PWM_RC_MID - 50) return PWM_In_Mid;
...
{																					 
  ...
  {      
		...
		else	
		{
			...
			if(TMP > CH1_Rising)
				PWM_In_Data.CH3 = TMP - CH1_Rising; 
			else
				PWM_In_Data.CH3 = 65535 + TMP - CH1_Rising;
  ...
  {      
		...
		else	
		{
			...
			if(TMP > CH2_Rising)
				PWM_In_Data.CH4 = TMP - CH2_Rising; 
			else
				PWM_In_Data.CH4 = 65535 + TMP - CH2_Rising;
  ...
  {      
		...
		else	
		{
			...
			if(TMP > CH3_Rising)
				PWM_In_Data.CH5 = TMP - CH3_Rising; 
			else
				PWM_In_Data.CH5 = 65535 + TMP - CH3_Rising;
  ...
  {      
		...
		else	
		{
			...
			if(TMP > CH4_Rising)
				PWM_In_Data.CH6 = TMP - CH4_Rising; 
			else
				PWM_In_Data.CH6 = 65535 + TMP - CH4_Rising;
