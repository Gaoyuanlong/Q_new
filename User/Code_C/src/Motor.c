...
void Motor_Output(BOOL IsHold)
{
	...
	{
		PWM_TMP.PWM1 = Math.Constrain(PWM_Data.PWM1 + PWM_LIMIT_D,PWM_LIMIT_U,PWM_LIMIT_D);
		PWM_TMP.PWM2 = Math.Constrain(PWM_Data.PWM2 + PWM_LIMIT_D,PWM_LIMIT_U,PWM_LIMIT_D);
		PWM_TMP.PWM3 = Math.Constrain(PWM_Data.PWM3 + PWM_LIMIT_D,PWM_LIMIT_U,PWM_LIMIT_D);
		PWM_TMP.PWM4 = Math.Constrain(PWM_Data.PWM4 + PWM_LIMIT_D,PWM_LIMIT_U,PWM_LIMIT_D);
		PWM_TMP.PWM5 = Math.Constrain(PWM_Data.PWM5 + PWM_LIMIT_D,PWM_LIMIT_U,PWM_LIMIT_D);
		PWM_TMP.PWM6 = Math.Constrain(PWM_Data.PWM6 + PWM_LIMIT_D,PWM_LIMIT_U,PWM_LIMIT_D);
	}
...
void Motor_Stop(void)
{
	...
	TIM_SetCompare3(TIM2,PWM_LIMIT_D);
	TIM_SetCompare4(TIM3,PWM_LIMIT_D);
	TIM_SetCompare3(TIM3,PWM_LIMIT_D);
	TIM_SetCompare2(TIM3,PWM_LIMIT_D);
	TIM_SetCompare1(TIM3,PWM_LIMIT_D);
	TIM_SetCompare4(TIM2,PWM_LIMIT_D);
}
